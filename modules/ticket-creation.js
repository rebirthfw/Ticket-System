                ...
                case "general-help":
                    await interaction.guild.channels.create(`⏰-t-${data2.index + 1}-${interaction.user.username}`, {
                        ...
                        const GeneralHelpEmbed = new MessageEmbed()
                            ...
                            .setDescription(`Привет <@${interaction.user.id}>,\n Персонал уже оповещён и займётся Вашим вопросом как можно скорее, а пока сообщите нам о своей проблеме!`)
                            .setColor(ee.color)
                            .setTimestamp()
                            .setAuthor({
                        ...
                        channel.send({
                             content: `Добро пожаловать <@${interaction.user.id}>, ожидаем подключения к данному диалогу наших сотрудников @&957560771263483915>`,
...
Персонал уже оповещён о Вашей ситуации и займётся Вашим вопросом как можно скорее, а пока мы ожидаем подключения специалиста расскажите нам об ошибке, с которой вы столкнулись, наиболее подробно, чтобы ускорить обработку.`)
                            .setColor(ee.color)
                            .setTimestamp()
                            .setAuthor({
                                name: interaction.guild.name,
                        ...
                        channel.send({
                             content: `Здраствуйте <@${interaction.user.id}>, ожидайте, пожалуйста, подключения наших сотрудников <@&980873561478664232>`,
                ...
                case "order-bot":
                    await interaction.guild.channels.create(`⏰-t-${data2.index + 1}-${interaction.user.username}`, {
                        ...
                        const OrderedEmbed = new MessageEmbed()
                            .setTitle('__**Билет открыт!**__')
                            .setDescription(`Привет <@${interaction.user.id}>,\nХантер уже оповещён и займётся Вашим вопросом как можно скорее, во время ожидания Вы можете предоставить информацию, указанную ниже!`)
                            .setColor(ee.color)
                            .setTimestamp()
                            .setAuthor({
                                name: interaction.guild.name,
                        ...
                        const OrderedEmbed2 = new MessageEmbed()
                            ...
                            .setDescription(`> **Дату и время.\n> Не обрезанный, не отредактированный развёрнутый скриншот со всей историей переписки.\n> Ваш никнейм в игре (скопирован с игры).\n> Никнейм нарушителся (скопирован с игры). А также дополнительную информацию, которую хотите передать для ускорения обработки Вашего запроса.**`)
                            .setColor(ee.color)
                        ...
                        channel.send({
                            content: `Здраствуйте <@${interaction.user.id}>, ожидайте, пожалуйста, сотрудника  <@&980848496401846302>`,
                ...
                case "partner-apply":
                    await interaction.guild.channels.create(`⏰-t-${data2.index + 1}-${interaction.user.username}`, {
                        ...
                        const embed = new MessageEmbed()
                            .setTitle('__**Билет открыт!**__')
                            .setDescription(`Привет <@${interaction.user.id}>,\nПерсонал уже поповещён о Вашей заявке.`)
                            .setColor(ee.color)
                            .setTimestamp()
                            .setAuthor({
                                name: interaction.guild.name,
                ...
                case "source-code":
                    await interaction.guild.channels.create(`⏰-t-${data2.index + 1}-${interaction.user.username}`, {
                        ...
                        const embed = new MessageEmbed()
                            ...
                            .setDescription(`Привет <@${interaction.user.id}>,\nПерсонал уже оповещён и займётся Вашим вопросом как можно скорее, а пока сообщите нам свой вопрос по игре.`)
                            .setColor(ee.color)
                            .setTimestamp()
                            .setAuthor({
                                name: interaction.guild.name,
                        ...
                        channel.send({
                             content: `Привет <@${interaction.user.id}>,ожидайте  <@&977448784520966144>`,
                            embeds: [embed],
                            components: [closeTicket]
                        }).then((msg) => msg.pin())
